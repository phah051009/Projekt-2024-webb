//Öppnar popup för ändra bakgrundsfärg
...
function closebutton() {
    const closebutton = document.getElementById("informationcolor").style.display = "none";
}

//Öppnar popup för ändra typsnitt
function Getinfoboxfont() {
    const informationdiv = document.getElementsByClassName("informationfont");
    document.getElementById("informationfont").style.display = "block"
}
function closebuttonfont() {
    const closebutton = document.getElementById("informationfont").style.display = "none";
}
 
//Öppnar popup för ändra textfärg
function Getinfoboxtextcolor() {
    const informationdiv = document.getElementsByClassName("informationtextcolor");
    document.getElementById("informationtextcolor").style.display = "block"
}
function closebuttontext() {
    const closebuttontext = document.getElementById("informationtextcolor").style.display = "none";
}

//Öppnar menyn för ändra navbar inställningar
function Getinfoboxnavcolor() {
    const informationdiv = document.getElementsByClassName("informationnavcolor");
    document.getElementById("informationnavcolor").style.display = "block"
}
function closebuttonnav() {
    const closebuttontext = document.getElementById("informationnavcolor").style.display = "none";
}
